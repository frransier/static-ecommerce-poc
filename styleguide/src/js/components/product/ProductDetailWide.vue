<template>
    <div class="product-detail product-detail--wide">
        <Modal
        ...
        <section class="section section--full section--no-x-padding section--no-bottom-padding h-border-bottom">
            <ProductImages
                :media="media"
                :useAlternativeLayout="true"
                :displayDiscountTag="prices.discounted.length > 0"
                :displayIsNewTag="isNew"
            />
        </section>
        <div class="grid grid--no-gutter grid--col-xs-1 grid--col-sm-1">
            <div class="grid__item grid__item--no-gutter grid__item--6">
                <section class="section section--full section--no-padding">
                    <section class="section product-detail__half-section product-detail__half-section--left">
            ...
            <div class="grid__item grid__item--no-gutter grid__item--6">
                <section class="section section--full section--no-padding section--grey">
                    <section class="section product-detail__half-section product-detail__half-section--right">
                        <h2 class="product-detail__heading">{{ $getDictionaryValue('Page.ProductDetail.Headings.Description', 'Beskrivning') }}</h2>
                        <div class="wysiwyg-content wysiwyg-content--no-gutter" v-html="longDescription"></div>
