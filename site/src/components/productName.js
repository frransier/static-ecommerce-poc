...
const ProductName = props => {
  ...
  return (
    <div className={['product-name', `${props.isBreak ? 'product-name--break' : ''}`]}>
      {props.brand &&
      ...
      <HeadingElement className={['product-name__name', `${props.isHeadingInheritSize ? 'product-name__name--inherit-size' : ''}`]}>
        {props.url ? (
