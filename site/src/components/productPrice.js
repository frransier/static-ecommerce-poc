  ...
  return (
    <div
      className={`product-price ${
        props.isBig || props.dicountedPriceIsHighlighted
          ? "product-price--big"
          : null
      }`}
    >
      ...
      {hasDicountPrice && (
        <strong
          className={`product-price__discounted ${
            props.clubPrice ? "product-price__discounted--club" : null
          }`}
        >
      ...
      {props.regularPrice && (
        <span
          className={`product-price__regular ${
            hasDicountPrice ? "product-price__regular--is-not-current" : null
          }`}
        >
