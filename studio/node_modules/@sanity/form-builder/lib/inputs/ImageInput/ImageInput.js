...
class ImageInput extends _react.default.PureComponent {
  constructor() {
    ...
    _defineProperty(this, "getConstrainedImageSrc", assetDocument => {
      ...
      var constrainedSrc = `${assetDocument.url}?w=${maxSize}&h=${maxSize}&fit=max`;
