        ...
        operations.forEach(op => {
          if (isRemote) {
            ...
            try {
              ...
              console.log(`Got error trying to apply local operation. The error was '${err.message}' The operation was ${JSON.stringify(op.toJSON())}`); // Restore to current formbuilder value (but try to apply the last known selection)
