...
class DecoratorButtons extends _react.default.Component {
  constructor() {
    ...
    _defineProperty(this, "renderDecoratorButton", item => {
      ...
      var shortCut = _SetMarksOnKeyComboPlugin.keyMaps[item.value] ? `(${_SetMarksOnKeyComboPlugin.keyMaps[item.value]})` : '';
      var title = `${item.title} ${shortCut}`;
  ...
  render() {
    ...
    if (items.length > 0 && collapsed) {
      return _react.default.createElement(_CollapsibleButtonGroup.default, {
