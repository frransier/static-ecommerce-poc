...
var getProductionPreviewItem = (draft, published) => {
  ...
  try {
    ...
    error.message = `An error was thrown while trying to get production preview url: ${error.message}`; // eslint-disable-next-line no-console
