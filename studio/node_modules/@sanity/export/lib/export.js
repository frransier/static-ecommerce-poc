...
function exportDataset(opts) {
  ...
  var prefix = `${opts.dataset}-export-${slugDate}`;
  ...
  function () {
    var _ref = _asyncToGenerator(function* (resolve, reject) {
      ...
      var jsonStream = miss.pipeline(inputStream, logFirstChunk(), split(JSON.parse), rejectOnApiError(), filterSystemDocuments(), assetStreamHandler, filterDocumentTypes(options.types), options.drafts ? miss.through.obj() : filterDrafts(), stringifyStream(), miss.through(reportDocumentCount));
      ...
      function () {
        var _ref3 = _asyncToGenerator(function* (err) {
          ...
          var progressInterval = setInterval(() => {
            var completed = assetHandler.queueSize - assetHandler.queue.size;
